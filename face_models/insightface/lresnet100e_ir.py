...
from utils import l2_normalizer
...
def LResNet100E_IR(input_shape=(112, 112, 3), normalize_embeddings=False, weights_path=None, **kwargs):
    inp = Input(shape=input_shape)
    # Preprocessing : (x - 127.5) / 128

    conv0 = ZeroPadding2D(1)(inp)
    ...
    model = Model(inp, x, name="LResNet100E_IR")
